...
class Ui_Dialog_Editar_Tecla(object):
    def setupUi(self, Dialog):
        ...
        self.componente_input = QtWidgets.QLineEdit(Dialog)
        self.componente_input.setGeometry(QtCore.QRect(80, 40, 440, 25))
        self.componente_input.setObjectName("roca")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Componente:"))
