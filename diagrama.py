...
def field_boundaries(scheme):
    ...
    if scheme == 'Pettijohn_1977':
        ...
        c1 = ['feldespática', A, D, N, E, A]
        c2 = ['cuarzosa', C, I, P, J, C]
        c3 = ['lítica', B, G, O, F, B]

        c4 = ['cuarzo-feldespática', E, N, Q, K, E]
        c5 = ['feldespática-cuarzosa', K, Q, P, I, K]
        c6 = ['lítica-cuarzosa', P, J, L, R, P]
        c7 = ['cuarzo-lítica', R, L, G, O, R]
        c8 = ['lito-feldespática', D, N, S, H, D]
        c9 = ['feldespato-lítica', O, F, H, S, O]
        ...
        l4 = ["cuarzo-feldespática", 0.2, 0.3, 55]
        l5 = ["feldespática-cuarzosa", 0.38, 0.65, 55]
        l6 = ["lítica-cuarzosa", 0.6, 0.7, 305]
        l7 = ["cuarzo-lítica", 0.8, 0.3, 305]
        l8 = ["lito-feldespática", 0.3, 0.05, 0]
        l9 = ["feldespato-lítica", 0.7, 0.05, 0]
        l10 = ["IQF", 0.32, 0.35, 0]
        l11 = ["IFQ", 0.43, 0.5, 0]
        l12 = ["fLQ", 0.57, 0.5, 0]
        l13 = ["fQL", 0.67, 0.35, 0]
